$(document).ready(function() {
  ...
  $('.hs-link').click(function() {
    ...
    if ($(this).attr('id') == 'zip_btn') {
      var zipcode = $('#zip_input').val();
      // var regex = new RegExp(/^[0-9]{1,10}$/);
      var regex = new RegExp(/^\d{5}$/);
    }
    if ($(this).attr('id') == 'zip_help_btn') {
      var zipcode = $('#zip_help_input').val()
    }
    if ($(this).attr('id') == 'exterior_btn') {
  ...
  $('.when-last-step ul li .when-link').click(function() {
    $('#slides > section').removeClass('hs-slide-left-0').addClass('hs-slide-left--100');
    $('#search').show();
    $('#intro').hide();
    $('#cards').hide();
  ...
  $('#name #name_btn').click(function() {
    ...
    if( $('#last_name_input').val() == '' || $('#last_name_input').val() == "null") {
      ...
      $(this).closest('#name').removeClass('card-left-0').addClass('card-left--100');
      setTimeout(function() {
        $(this).closest('#name').removeClass('card-p-a');
      }, 700);
  ...
  $('#email #email_btn').click(function(e) {
    ...
    if (validateEmail(sEmail)) {
      // Email is valid
      $(this).closest('#email').removeClass('card-left-0').addClass('card-left--100');
      setTimeout(function() {
        $(this).closest('#email').removeClass('card-p-a');
      }, 700);
  ...
  $('#number #number_btn').click(function() {
    ...
    if(number_input.match(regex)) {
      $(this).closest('#number').removeClass('card-left-0').addClass('card-left--100');
      setTimeout(function() {
        $(this).closest('#number').removeClass('card-p-a');
      }, 700);
  ...
  $('#verify_number #verify_number_text_btn').click(function() {
    ...
    if(verify_number_input.match(regex)) {
      $(this).closest('#verify_number').removeClass('card-left-0').addClass('card-left--100');
      setTimeout(function() {
        $(this).closest('#number').removeClass('card-p-a');
      }, 700);
  ...
  $('#code #code_btn').click(function() {
    ...
    if(code_input.match(regex)) {
      $(this).closest('#code').removeClass('card-left-0').addClass('card-left--100');
      setTimeout(function() {
        $(this).closest('#code').removeClass('card-p-a');
      }, 700);
  ...
  $('#first_name_input, #last_name_input, #email_input, #number_input, #verify_number_input, #code_input').keypress(function() {
  ...
  if (state !== null) {
    switch(state.foo) {
      ...
      case "step3":
        ...
        // Slides
        $('#rooms').removeClass('hs-slide-opacity-1 hs-slide-left-0');
        $('#exterior').removeClass('hs-slide-opacity-1 hs-slide-left-0');
        // End
      break;
      ...
      case "step5":
        ...
        // Slides
        $('#work_type, #int_ext, #rooms, #exterior, #when').removeClass('hs-slide-left--100').addClass('hs-slide-opacity-1 hs-slide-left-0');
        // End
      break;
      ...
      case "step6":
        ...
        // Form steps
        $('#name').addClass('card-left-0').removeClass('card-left--100');
      ...
      case "step7":
        ...
        // Form steps
        $('#email').addClass('card-left-0').removeClass('card-left--100');
      ...
      case "step8":
        ...
        // Form steps
        $('#number').addClass('card-left-0').removeClass('card-left--100');
      ...
      case "step9":
        ...
        // Form steps
        $('#verify_number').addClass('card-left-0').removeClass('card-left--100');
      ...
      case "step10":
        ...
        // Form steps
        $('#code').addClass('card-left-0').removeClass('card-left--100');
